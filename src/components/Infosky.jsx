    ...
    return (
        <Container style={{backgroundColor: '#e0c8a0'}} className="py-4" fluid>
            <Row className="px-4 text-center">
                <Col>
                    <article style={{fontSize: '250%'}} className="shorelines">&nbsp;&nbsp;&nbsp;(co {'@'} ako)</article>
                </Col>
            </Row>
            ...
            <InfoElement leftText={"Doprava"} rightText={`Bude k dispozícii mikrobus, ktorý bude jazdiť medzi Bratislavou a Modrou.
                    Avšak využitelný bude až pri naplnenosti 5+ ľudí, takže bude treba sa skoordinovať s ostatnými hosťami.
                    Taxík nehradíme, ale cena je približne 25€.`} />
            <InfoElement leftText={"Ubytovanie"} rightText={<span>Ubytko hradíme rodine, pre ostatných je v okolí k dispozícii pár penziónov ako &nbsp;
                    <a style={{color: '#894937'}} target="_blank" rel="noopener noreferrer" href="https://www.google.com/maps/place/Club+MKM/@48.3339642,17.3104256,18.05z/data=!4m16!1m7!3m6!1s0x476c9776ff45bc11:0x2727c6017450a128!2sModra!3b1!8m2!3d48.3344706!4d17.3072873!3m7!1s0x476c9777c13387b1:0x6b7bb76481091145!5m2!4m1!1i2!8m2!3d48.3340379!4d17.3117396">MGM Club Penzión</a></span>} />
        </Container>
    )
}